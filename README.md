...
git add . && git commit -m "feat: done"  # Review runs automatically ✅
```
...
- **`.gga.copilot-claude-haiku-template`** — GitHub Copilot with Claude Haiku 4.5 (lightweight, fast)
