...
*Before reviewing code, verify the "Spec-First" compliance.*
- [ ] **Spec Exists**:
    - **Features**: `specs/<feature>/spec.md` AND `plan.md` exist in the PR or repo.
    - **Bugfixes**: `specs/bugs/<ticket>.md` exists **OR** PR description includes "Bugfix Rationale".
- [ ] **Alignment**: The implemented code matches the plan defined in `plan.md`.
